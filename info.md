[goal]
create a way to procedraly generate a massive list of workers to hire
...
all hires must have predetermined attire/hair/body/mesh at realistic styles with a set random seed of "1337" and each new hire generated is to be genrated as if the rng was rolled at the first epoc time standerd
